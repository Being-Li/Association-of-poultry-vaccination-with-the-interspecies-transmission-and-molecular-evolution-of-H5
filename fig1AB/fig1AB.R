...
data<-read_xlsx("\\gisaid_epiflu_isolates_global_20230714.xlsx",sheet = "year_continent_all")
data_p<-read_xlsx("\\gisaid_epiflu_isolates_global_20230714.xlsx",sheet = "year_continent_p")[1:6,]
data_w<-read_xlsx("\\gisaid_epiflu_isolates_global_20230714.xlsx",sheet = "year_continent_w")[1:7,]
...
#############
data<-read_xlsx("\\gisaid_epiflu_isolates_global_20230714.xlsx",sheet = "hist")
...
##############
rm(list = ls())
data_p<-read_xlsx("\\gisaid_epiflu_isolates_global_20230714.xlsx",sheet = "year_country_p")
data_w<-read_xlsx("\\gisaid_epiflu_isolates_global_20230714.xlsx",sheet = "year_country_w")
data_all<-read_xlsx("\\gisaid_epiflu_isolates_global_20230714.xlsx",sheet = "year_country")
